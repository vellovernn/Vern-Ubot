    ...
    if HEROKU_API_KEY is not None:
        ...
        if HEROKU_APP_NAME is None:
            await event.edit(
                ...
                ' untuk dapat deploy perubahan terbaru dari ⚡Vern-Ubot⚡.`'
            )
            repo.__del__()
            return
        ...
        await event.edit('`[HEROKU]:'
                         '\nSedang MengUpdate ⚡Vern-Asisstant⚡, Mohon Menunggu 5-7 Menit`'
                         )
        ups_rem.fetch(ac_br)
...
async def update(event, repo, ups_rem, ac_br):
    ...
    await event.edit('**⚡Vern-Ubot⚡** `Berhasil Di Update!`')
    await asyncio.sleep(1)
    await event.edit('**⚡Vern-Ubot⚡** `Di Restart....`')
    await asyncio.sleep(1)
...
async def upstream(event):
    ...
    if changelog == '' and force_update is False:
        await event.edit(
            f'\n⚡Vern-Ubot⚡ Sudah Versi Terbaru\n')
        await asyncio.sleep(15)
        await event.delete()
        return repo.__del__()

    if conf is None and force_update is False:
        changelog_str = f'**Pembaruan Untuk ⚡Vern-Ubot⚡ :\n\n💻 Pembaruan Data :**\n`{changelog}`'
    ...
    if force_update:
        ...
        await event.edit('` Proses Update ⚡Vern-Ubot, Loading....1%`')
        await event.edit('` Proses Update ⚡Vern-Ubot, Loading....20%`')
        await event.edit('` Proses Update ⚡Vern-Ubot, Loading....35%`')
        await event.edit('` Proses Update ⚡Vern-Ubot, Loading....77%`')
        await event.edit('` Proses Update ⚡Vern-Ubot, Updating...90%`')
        await event.edit('` Proses Update ⚡Vern-Ubot, Mohon Tunggu Sebentar....100%`')
    if conf == "now":
